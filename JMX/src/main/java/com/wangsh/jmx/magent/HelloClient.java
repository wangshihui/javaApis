...
import com.wangsh.jmx.mbeans.HelloMBean;

public class HelloClient{

    public static void main(String[] args) throws IOException, Exception, NullPointerException {
        String port="1099";
        JMXServiceURL url = new JMXServiceURL("service:jmx:rmi:///jndi/rmi://localhost:"+port+"/MyMBean");
...
//        mbsc.invoke(mbeanName, "getTelephone", null, null);
        ...
        mbsc.invoke(mbeanName, "print", null, null);
    }
}
