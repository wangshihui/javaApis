...
package com.wangsh.jmx.example.notification;
...
public class Hello extends NotificationBroadcasterSupport implements HelloMBean {
	 ...
	 * 第二部链接jconsole
	 * 第三部点击Mbean 标签
	 * 第四步选择 hello bean->通知-》订阅
	 * 第五步在jconsole中修改cacheSize的值
	 * 
	 */
	public synchronized void setCacheSize(int size) {
		 ...
		 * by this MBean.
		 * 
		 * The oldValue and newValue parameters to the constructor are of type Object,
		 * so we are relying on Tiger's autoboxing here.
		 */
		...
		/*
		 * Now send the notification using the sendNotification method inherited from
		 * the parent class NotificationBroadcasterSupport.
		 */
		sendNotification(n);
	}
