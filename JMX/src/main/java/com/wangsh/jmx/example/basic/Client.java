package com.wangsh.jmx.example.basic;
...
public class Client {
	...
	public static void main(String[] args) {
		try {
			...
			echo("\nCreate SimpleStandard MBean...");
			mbsc.createMBean("com.wangsh.jmx.example.basic.SimpleStandard", stdMBeanName, null, null);
			waitForEnterPressed();
			...
			echo("\nCreate SimpleDynamic MBean...");
			mbsc.createMBean("com.wangsh.jmx.example.basic.SimpleDynamic", dynMBeanName, null, null);
			waitForEnterPressed();
...
//			sleep(2000);
			...
			addListenerForRemoteSimpleDynamic(mbsc,listener);
//			echo("\n addListenerForRemoteSimpleDynamicr SimpleDynamic MBean...");
//			echo("\n ---------------------------------------------------------.");
			waitForEnterPressed();
//			echo("\n ---------------------------------------------------------.");
//			waitForEnterPressed();
//			echo("\n ---------------------------------------------------------.");
			...
			removeNotificationListenerForRemoteSimpleDynamic(mbsc,listener);
	...
	private static void addListenerForRemoteSimpleDynamic(MBeanServerConnection mbsc,NotificationListener listener)  {
		try {
			echo("\n addListenerForRemoteSimpleDynamic start");
			String defaultDomain=mbsc.getDefaultDomain();
			String mbeanClassName = "com.wangsh.jmx.example.basic.SimpleDynamic";
			String mbeanObjectNameStr = defaultDomain + ":type=" + mbeanClassName + ",name=1";
			ObjectName mbeanObjectName = ObjectName.getInstance(mbeanObjectNameStr);
//			ObjectInstance o = mbsc.getObjectInstance(mbeanObjectName);
			mbsc.addNotificationListener(mbeanObjectName, listener, null, null);
		}catch( MalformedObjectNameException| NullPointerException| IOException| InstanceNotFoundException e) {
			e.printStackTrace();
		}
	}
	
	private static void removeNotificationListenerForRemoteSimpleDynamic(MBeanServerConnection mbsc,NotificationListener listener) {
		try {
			echo("\n removeNotificationListenerForRemoteSimpleDynamic start");
			String defaultDomain=mbsc.getDefaultDomain();
			String mbeanClassName = "com.wangsh.jmx.example.basic.SimpleDynamic";
			String mbeanObjectNameStr = defaultDomain + ":type=" + mbeanClassName + ",name=1";
			ObjectName mbeanObjectName = ObjectName.getInstance(mbeanObjectNameStr);
//			ObjectInstance o = mbsc.getObjectInstance(mbeanObjectName);
		...
		}catch( MalformedObjectNameException| NullPointerException| IOException| InstanceNotFoundException | ListenerNotFoundException e) {
			e.printStackTrace();
		}
	}
