...
public class Server {
	...
	public static void main(String[] args) {
		try {
			...
			// createMBeanServer() 每次调用创建一个新的MBeanServer
			// 
			// ManagementFactory.getPlatformMBeanServer() 也是调用createMBeanServer()方法创建MBeanServer
			// 不同的是getPlatformMBeanServer() 一旦创建成功，再次调用getPlatformMBeanServer方法，会返回同一个实例
			// getPlatformMBeanServer方法会注册一些默认的MBean
			//
			...
			//
			String mbeanClassName = "com.wangsh.jmx.example.basic.SimpleStandard";
			...
			//
			mbeanClassName = "com.wangsh.jmx.example.basic."
					+ "SimpleDynamic";
